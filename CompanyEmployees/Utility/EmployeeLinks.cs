...
namespace CompanyEmployees.Utility
{
    public class EmployeeLinks : IEmployeeLinks
    {
        ...
        public LinkResponse TryGenerateLinks(IEnumerable<EmployeeDto> employeeDto,
        ...
        private LinksCollectionWrapper<ExpandoObject> CreateLinksForEmployees(HttpContext httpContext, LinksCollectionWrapper<ExpandoObject> employeesWrapper)
        {
